...
class _QualificationsState extends State<Qualifications> {
  ...
  Future<void> getQualifications() async {
    String url = "${Urls.apiUrl}/api/jobseekers/${global.nic}/qualifications";
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const EditQualifications()),
                      );
                    },
                    child: Text("UPDATE"),
                  ),
...
class _EditQualificationsState extends State<EditQualifications> {
  ...
  Future<void> updateQualifications() async {
    var request = http.Request(
        'PUT',
        Uri.parse(
            '${Urls.apiUrl}/jobseekers/qualifications/update?nic=${global.nic}&olEnglish=$selOLEnglish&olScience=$selOLScience&olMaths=$selOLMaths&alStream=$selAlStream&alResults=$selAlResults&alEnglish=$selAlEnglish&hEdu=$selHighEdStage&hEduField=$selHighEdField'));
