...
class _ComplaintsState extends State<Complaints> {
  ...
  setValues(complain, feedback, complainId, nic, date) {
    setState(() {
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return GestureDetector(
                                                    ...
                                                    child: Card(
                                                        ...
                                                        child: ListTile(
                                                          title: Text(
                                                              "ID: ${data[index].complainId.toString()} | NIC: ${data[index].jsNic.toString()}"),
                                                          subtitle: Text(
                                                            data[index]
                                                                .complain,
                                                            overflow:
                                  ...
                                  children: [
                                    Expanded(
                                      ...
                                      child: FutureBuilder<List<Data>>(
                                        ...
                                        builder: (context, snapshot) {
                                          if (snapshot.hasData) {
                                            List<Data>? olddata = snapshot.data;
                                            return ListView.builder(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return GestureDetector(
                                                    onTap: () {
                                                      setValues(
                                                        olddata[index].complain,
                                                        olddata[index].feedback,
                                                        olddata[index]
                                                            .complainId,
                                                        olddata[index].jsNic,
                                                        olddata[index].date,
